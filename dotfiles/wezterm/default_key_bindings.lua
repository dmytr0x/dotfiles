...
return {
  ...
  key_tables = {
    ...
    events = {
      { key = "o", mods = "NONE", action = act.EmitEvent("opacity-toggle") },
    },

    pane_actions = {
      { key = "f", mods = "NONE", action = act.TogglePaneZoomState },
      {
        key = "g",
        mods = "NONE",
    ...
    rotate_panes = {
      { key = "Escape", mods = "NONE", action = act.PopKeyTable },
      { key = "h", mods = "NONE", action = act.RotatePanes("Clockwise") },
      { key = "l", mods = "NONE", action = act.RotatePanes("CounterClockwise") },
      { key = "LeftArrow", mods = "NONE", action = act.RotatePanes("Clockwise") },
      { key = "RightArrow", mods = "NONE", action = act.RotatePanes("CounterClockwise") },
    },
